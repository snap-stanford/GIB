...
parser.add_argument('--date_time', default="4-6", help="Today's date and time.")
args = parser.parse_args()


# For explanation of the args, see experiments/GIB_node_exp.py.
shared_args = {
    "num_layers": 2,
    "reparam_mode": "diag",
...
for seed in [0, 1, 2, 3, 4]:
    exec_str = "python {}/experiments/GIB_node_exp.py --seed={}".format(get_root_dir(), seed)
